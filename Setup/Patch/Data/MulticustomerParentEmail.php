...
namespace M2Commerce\MultiCustomerManagement\Setup\Patch\Data;
...
/**
 * Class MulticustomerParentEmail
 */
class MulticustomerParentEmail implements DataPatchInterface
{
    /**
    ...
    {
        $attributecode = "multicustomer_parent_email";
        ...
        $customerSetup->addAttribute(Customer::ENTITY, $attributecode, [
            'type' => 'varchar',
            'input' => 'text',
            'label' => 'Multi Customer Parent Email',
            'required' => false,
            'visible' => true,
            'user_defined' => true,
            'system' => false,
